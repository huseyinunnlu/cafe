                    ...
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <ul class="social-icons">
                               @if($chef->social1)<li><a href="#{{$chef->social1}}"><i class="fa fa-facebook"></i></a></li>@endif
                               @if($chef->social2)<li><a href="#{{$chef->social1}}"><i class="fa fa-facebook"></i></a></li>@endif
                               @if($chef->social3)<li><a href="#{{$chef->social1}}"><i class="fa fa-facebook"></i></a></li>@endif
                               @if($chef->social4)<li><a href="#{{$chef->social1}}"><i class="fa fa-facebook"></i></a></li>@endif
                            </ul>
                            <img src="{{asset($chef->photo)}}" alt="Chef #1">
                        </div>
